 ...
 * whenever the swipe to refresh gesture is completed. The
 * SwipeRefreshLayout
 * will notify the listener each and every time the gesture is completed
 * again;
 * the listener is responsible for correctly determining when to actually
 * initiate a refresh of its content. If the listener determines there
 * should
 * not be a refresh, it must call setRefreshing(false) to cancel any visual
 * indication of a refresh. If an activity wishes to show just the progress
 * animation, it should call setRefreshing(true). To disable the gesture
 * and progress
 * animation, call setEnabled(false) on the view.
 * 
 * <p>
 * This layout should be made the parent of the view that will be refreshed
 * as a result of the gesture and can only support one direct child. This
 * view will also be made the target of the gesture and will be forced to
 * match both the width and the height supplied in this layout. The
 * SwipeRefreshLayout does not provide accessibility events; instead, a
 * menu item must be provided to allow refresh of the content wherever this
 * gesture is used.
 * </p>
 */
public class SwipeRefreshLayout extends ViewGroup {
    ...
    /**
     * Simple constructor to use when creating a SwipeRefreshLayout from
     * code.
     * 
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating SwipeRefreshLayout from
     * XML.
     * 
     * @param context
     * @param attrs
     ...
     * 
     * @param refreshing Whether or not the view should show refresh
     *        progress.
     */
    ...
    /**
     * Simple AnimationListener to avoid having to implement unneeded
     * methods in
     * AnimationListeners.
     */
